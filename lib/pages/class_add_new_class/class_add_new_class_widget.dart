...
import 'class_add_new_class_model.dart';
export 'class_add_new_class_model.dart';

class ClassAddNewClassWidget extends StatefulWidget {
  const ClassAddNewClassWidget({super.key});

  @override
  State<ClassAddNewClassWidget> createState() => _ClassAddNewClassWidgetState();
}

class _ClassAddNewClassWidgetState extends State<ClassAddNewClassWidget> {
  late ClassAddNewClassModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClassAddNewClassModel());
