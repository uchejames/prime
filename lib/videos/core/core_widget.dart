...
class _CoreWidgetState extends State<CoreWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoreModel());
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: StreamBuilder<List<CoreRecord>>(
                      stream: FFAppState().core(
                        requestFn: () => queryCoreRecord(
                          queryBuilder: (coreRecord) =>
                              coreRecord.orderBy('Duration'),
                        ),
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<CoreRecord> listViewCoreRecordList =
                            snapshot.data!;
                        ...
                        return ListView.separated(
                          ...
                          itemCount: listViewCoreRecordList.length,
                          separatorBuilder: (_, __) => const SizedBox(height: 20.0),
                          itemBuilder: (context, listViewIndex) {
                            final listViewCoreRecord =
                                listViewCoreRecordList[listViewIndex];
                            return Padding(
