              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: StreamBuilder<List<StretchsRecord>>(
                      stream: FFAppState().stretch(
                        requestFn: () => queryStretchsRecord(
                          queryBuilder: (stretchsRecord) =>
                              stretchsRecord.orderBy('Duration'),
                        ),
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<StretchsRecord> listViewStretchsRecordList =
                            snapshot.data!;
                        ...
                        return ListView.separated(
                          ...
                          itemCount: listViewStretchsRecordList.length,
                          separatorBuilder: (_, __) => const SizedBox(height: 20.0),
                          itemBuilder: (context, listViewIndex) {
                            final listViewStretchsRecord =
                                listViewStretchsRecordList[listViewIndex];
                            return Padding(
